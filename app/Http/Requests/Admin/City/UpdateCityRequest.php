...
/**
 * Request for updating an existing city.
 */
class UpdateCityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['required', 'string', 'max:10', Rule::unique('cities', 'code')->ignore($cityId)],
    ...
    public function withValidator(\Illuminate\Validation\Validator $validator): void
    {
        $validator->after(function ($validator): void {
            // Additional validation: if deactivating a city, check if it has active trips
            $city = $this->route('city');
            if ($city && $this->input('is_active') === false && $city->is_active) {
