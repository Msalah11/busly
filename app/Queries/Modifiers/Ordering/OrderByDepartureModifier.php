...
/**
 * Modifier for ordering trips by departure time.
 *
 * @template TModel of Model
 *
 * @extends AbstractQueryFilter<TModel>
 */
final class OrderByDepartureModifier extends AbstractQueryFilter
{
    /**
    ...
    /**
     * Apply the order by departure modifier to the query.
     *
    ...
    {
        return $query->orderBy('departure_time', $this->direction);
    }
}
